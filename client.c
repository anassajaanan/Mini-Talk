...
/*   Updated: 2023/07/22 08:22:51 by aajaanan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void signal_handler(int signal_number, siginfo_t *info, void *context)
{
    ...
    if (signal_number == SIGUSR1)
		ft_putstr_fd("🎉 Your message has been successfully received by the server! 🎉\n", 1);
	else
		ft_putstr_fd("🚨 An error occurred while sending your message to the server! 🚨\n", 1);
}
